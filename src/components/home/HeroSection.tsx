...
export function HeroSection({ searchQuery, onSearchChange }: HeroSectionProps) {
  ...
  return (
    <section className="w-full bg-[#E0F7FA]/50 py-12 md:py-20 text-center space-y-6">
      <div className="container mx-auto px-4 space-y-4">
        ...
        <div className="max-w-2xl mx-auto mt-8 relative group">
          ...
          {!searchQuery && (
            <div className="absolute left-14 top-1/2 -translate-y-1/2 z-0 pointer-events-none text-muted-foreground/60 flex items-center">
              <span>Search&nbsp;</span>
          ...
          <Input
            ...
            className="pl-14 h-14 rounded-full border-0 shadow-lg text-base bg-white focus:bg-white focus-visible:ring-0 focus-visible:ring-offset-0 placeholder-transparent z-10 relative transition-all"
